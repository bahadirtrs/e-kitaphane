  ...
  return (
    <View style={{width:Dimensions.get('screen').width, justifyContent:'center', alignItems:'center'}} >
      {item.sender=='CUSTOMER'
        ? <View style={{width:Dimensions.get('screen').width-20, justifyContent:'center', alignItems:'flex-end', marginBottom:10 }} >
        ...
        : <View style={{width:Dimensions.get('screen').width-20, justifyContent:'center', alignItems:'flex-start', marginBottom:10 }} >
